...
public class SimpleRealPlayerAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.yingyunshi_realplayer_item, null);
			// 获取控件对象
			viewHolder.mFigureIv = (ImageView) convertView
					.findViewById(R.id.default_figure_iv);
			viewHolder.mLoadingRL = (RelativeLayout) convertView
					.findViewById(R.id.realplay_loading_rl);
			viewHolder.mWaittingTv = (TextView) convertView
					.findViewById(R.id.realplay_watting_tv);
			viewHolder.mPlayIv = (ImageView) convertView
					.findViewById(R.id.realplay_play_iv);
		...
		updateFigureIvLayoutParams(viewHolder.mFigureIv,
				(int) (mDisplayWidth * Constant.LIVE_VIEW_RATIO));
	...
	public void updateFigureIvLayoutParams(ImageView figureIv, int height) {
		...
		if (mOrientation == Configuration.ORIENTATION_PORTRAIT) {
			RelativeLayout.LayoutParams figureLp = (LayoutParams) figureIv
					.getLayoutParams();
