 ...
 *
 */
public class NetConnectionTimeLine {
	 ...
	 */
	public static void TimeLineGetNetConnection(final String url,final String para,final String tokenAuth,
			final TimeLineSuccessCallBackGetAll successCallBack) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			new AsyncTask<Void, Void, List<HashMap<String, Object>>>() {
				...
				protected List<HashMap<String, Object>> doInBackground(
						Void... params) {
					try {
						SyncHttpTimeLine syncHttp = new SyncHttpTimeLine();
						try {
	...
	public static interface TimeLineSuccessCallBackGetAll {
