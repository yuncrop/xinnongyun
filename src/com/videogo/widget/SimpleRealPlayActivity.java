...
import com.videogo.widget.SimpleRealPlayerAdapter.RealPlayerHolder;
import com.xinnongyun.activity.CameraInfoActivity;
...
public class SimpleRealPlayActivity extends Activity implements OnClickListener, SurfaceHolder.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yingyunshi_realplayer_page);
    ...
    private void initViews() {
      ...
      //  mDisplayView = (RelativeLayout) findViewById(R.id.realplay_display_view);
        ...
        mBackBtn = (ImageView) findViewById(R.id.realplay_back_btn);
        ...
        findViewById(R.id.btn_collect_detail_setting).setOnClickListener(
        		new OnClickListener() {
					...
					public void onClick(View v) {
						Intent intentCamrea = new Intent();
						intentCamrea.setClass(SimpleRealPlayActivity.this, CameraInfoActivity.class);
						intentCamrea.putExtra("id", mCameraInfo.getCameraId());
						startActivityForResult(intentCamrea, 10);
					}
				}
        		);
        ...
        final String contentString = "视频直播";
        findViewById(R.id.share).setOnClickListener(
				new OnClickListener() {
					@SuppressWarnings("deprecation")
					@Override
					public void onClick(View arg0) {
						if(isPublish!=null && isPublish.equals("false"))
						{
							Toast.makeText(SimpleRealPlayActivity.this, R.string.camera_video_not_share, Toast.LENGTH_SHORT).show();
							return;
						}
						
						
						View popContent = LayoutInflater.from(SimpleRealPlayActivity.this).inflate(R.layout.sharepopwindow, null);
						...
						((IconFontTextView)popContent.findViewById(R.id.shareWinXinF)).setOnClickListener(
								new OnClickListener() {
									@Override
									public void onClick(View arg0) {
										ShareUtils.shareWXFriend(SimpleRealPlayActivity.this,
												"1",
												contentString,
												mCameraInfo.getPicUrl(),
												share_url);
									}
								}
								);
						((IconFontTextView)popContent.findViewById(R.id.shareWinXinFC)).setOnClickListener(
								new OnClickListener() {
									@Override
									public void onClick(View arg0) {
										ShareUtils.shareXWFriedCircle(SimpleRealPlayActivity.this,
												"1",
												contentString,
												mCameraInfo.getPicUrl(),
												share_url);
						...
						((IconFontTextView)popContent.findViewById(R.id.shareXinLang)).setOnClickListener(
								new OnClickListener() {
									@Override
									public void onClick(View arg0) {
										ShareUtils.shareXinLang(SimpleRealPlayActivity.this,
												"1",
												contentString,
												mCameraInfo.getPicUrl(),
												share_url);
						...
						((IconFontTextView)popContent.findViewById(R.id.shareQQF)).setOnClickListener(
								new OnClickListener() {
									@Override
									public void onClick(View arg0) {
										ShareUtils.shareQQF(SimpleRealPlayActivity.this,
												"1",
												contentString,
												mCameraInfo.getPicUrl(),
												share_url);
						...
						((IconFontTextView)popContent.findViewById(R.id.shareQQZ)).setOnClickListener(
								new OnClickListener() {
									@Override
									public void onClick(View arg0) {
										ShareUtils.shareQQZ(SimpleRealPlayActivity.this,
												"1",
												contentString,
												mCameraInfo.getPicUrl(),
												share_url);
						...
						popWindow.showAtLocation(findViewById(R.id.share), Gravity.CENTER, 0, 0);
					}
				}
				);
...
//        mWaitDialog.setCancelable(false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    	...
    	else if(requestCode==10 && resultCode==10)
    	{
    		...
    		final HashMap<String, String> cameraInfo = cameraDaoDBManager.getCameraInfoById(mCameraInfo.getCameraId());
    		if(cameraInfo!=null && cameraInfo.keySet().size()>0)
    		{
    			mTitleTv.setText(cameraInfo.get(TablesColumns.TABLECAMERA_NAME).toString());
    		}
    	}
    	else if(requestCode==10 && resultCode==30)
    	{
    		...
    		if(cameraInfo!=null && cameraInfo.keySet().size()>0)
    		{
    			isPublish = cameraInfo.get(TablesColumns.TABLECAMERA_PUBLISH).toString();
    		}
    	}
    }
        ...
        switch (errorCode) {
            ...
            case ErrorCode.ERROR_WEB_CODE_ERROR:
               ...
               // msg = Utils.getErrorTip(this, R.string.check_feature_code_fail, errorCode);
            	msg =getString(R.string.check_feature_code_fail);
                break;
...
//
//            mDisplayView.setBackgroundColor(getResources().getColor(R.color.yingyunshi_black));
//
...
//
//            mDisplayView.setBackgroundColor(getResources().getColor(R.color.common_bg));
