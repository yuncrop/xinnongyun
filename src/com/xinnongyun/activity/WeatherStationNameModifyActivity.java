 ...
 *
 */
public class WeatherStationNameModifyActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView)findViewById(R.id.userInfoModify_nameHint)).setText("请输入环境小站名称");
	...
	public void onClick(View view) {
		...
		case R.id.save_tv:
			...
			{
				DialogManager.showDialogSimple(WeatherStationNameModifyActivity.this,
	...
	private  void saveCollectInfo(String collectId)
	{
		...
		dg.show();
		String para = "farm="+MySharePreference.getValueFromKey(this, MySharePreference.FARMID)+ "&name=" + boxModify_name_et.getText().toString().trim();
		NetConnectionCollector.CollectorPutNetConnection(1,NetUrls.URL_WEATHER_STATIONSINFOCHANGE(collectId), para,
				...
				new CollectorSuccessCallBack() {
					...
					public void onSuccess(HashMap<String, Object> result) {
						...
						if(result!=null)
						{
							...
							{
								ErrorMarkToast.showCallBackToast(WeatherStationNameModifyActivity.this, result);
								return;
							}
							WeatherStationDaoDBManager daoDBManager = new WeatherStationDaoDBManager(WeatherStationNameModifyActivity.this);
							daoDBManager.updateWeatherStationById(result);
							setResult(10);
							finish();
						}
						else
