 ...
 *
 */
public class NetConnectionWeatherStation {
	 ...
	 */
	public static void WeatherGetNetConnection(final String url,final String para,final String tokenAuth, 
			final WeatherSuccessCallBack successCallBack) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			new AsyncTask<Void, Void, HashMap<String, Object>>() {
				...
				protected HashMap<String, Object> doInBackground(
						Void... params) {
					try {
						SyncHttpWeatherStation syncHttp = new SyncHttpWeatherStation();
						try {
	 ...
	 * @param successCallBack  返回结果 需自己实现
	 */
	public static void WeatherGetAllNetConnection(final String url,final String para,final String tokenAuth, 
			final WeatherAllSuccessCallBack successCallBack) {
	 ...
	 * @param successCallBack  返回结果 需自己实现
	 */
	public static void WeatherPutNetConnection(final String url,final String para,final String tokenAuth,
			final WeatherSuccessCallBack successCallBack) {
	 ...
	 * @param successCallBack  返回结果 需自己实现
	 */
	public static void WeatherDeleteNetConnection(final String url,final String para,final String tokenAuth,
			final WeatherSuccessCallBack successCallBack) {
	...
	public static interface WeatherAllSuccessCallBack {
		void onSuccess(List<HashMap<String, Object>> result);
	}
	
	public static interface WeatherSuccessCallBack {
