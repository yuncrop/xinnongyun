 ...
 *
 */
public class NetConnectionNotice {
	 ...
	 */
	public static void NoticeGetAllNetConnection(final String url,final String para,final String tokenAuth, 
			final NoticeAllSuccessCallBack successCallBack) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			new AsyncTask<Void, Void, List<HashMap<String, Object>>>() {
				...
				protected List<HashMap<String, Object>> doInBackground(
						Void... params) {
					try {
						SyncHttpNotice syncHttp = new SyncHttpNotice();
						try {
	 ...
	 * @param successCallBack  返回结果 需自己实现
	 */
	public static void NoticePutNetConnection(final String url,final String para,final String tokenAuth,
			final NoticeSuccessCallBack successCallBack) {
	...
	public static interface NoticeAllSuccessCallBack {
		void onSuccess(List<HashMap<String, Object>> result);
	}
	
	public static interface NoticeSuccessCallBack {
